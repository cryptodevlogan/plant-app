...
export default function WalkPage() {
  ...
  return (
    <>
      ...
      <main className={`min-h-screen relative overflow-hidden bg-gradient-to-b from-amber-50 via-orange-50 to-white ${isExpanded ? 'pb-8' : ''}`}>
        {!isExpanded && (
        ...
        {!isExpanded && (
          <div className="fixed bottom-8 left-0 right-0 flex justify-between px-6">
            <button
              ...
              className={`${playfair.className} px-4 py-2 rounded-full bg-amber-500 text-white text-sm 
